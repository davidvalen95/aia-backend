...
var ExpressService = /** @class */ (function (_super) {
    __extends(ExpressService, _super);
    function ExpressService() {
        var _this = _super.call(this) || this;
        _this.setAppExpress();
        return _this;
    }
    ExpressService.prototype.setAppExpress = function () {
        var _a;
        ...
        this.appExpress.use(function (req, res, next) {
        ...
        //# env.EXPRESS_PORT
        //# config.default.port
        var port = (_a = EnvService_1.EnvService.getInstance().get('EXPRESS_PORT')) !== null && _a !== void 0 ? _a : ConfigService_1.ConfigService.getInstance().get("port");
        if (!port) {
